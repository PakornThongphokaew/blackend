                                        ...
                                        <div class="row">
                                            <div class="col-md-12 px-1 px-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="pond_id" id="pond_id" placeholder="รหัสบ่อ" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="pond_name">ชื่อบ่อ</label>
                                                    <input type="text" class="form-control" name="pond_name" id="pond_name" placeholder="ชื่อบ่อ" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="pond_image">รูปภาพบ่อ</label>
                                                    <input type="file" class="form-control-file" id="pond_image" name="pond_image" accept="image/*" required>
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="pond_size" id="pond_size" placeholder="ขนาด" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="pond_detail">รายละเอียด</label>
                                                    <input type="text" class="form-control" name="pond_detail" id="pond_detail" placeholder="รายละเอียด" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="pond_rodprice">ราคาคันเบ็ด</label>
                                                    <input type="text" class="form-control" name="pond_rodprice" id="pond_rodprice" placeholder="ราคาคันเบ็ด" required>
                                                </div>
                                            </div>
                                        </div>
